...
import { ArrowLeft, RotateCcw, BookOpen, Highlighter } from 'lucide-react';
import Link from 'next/link';

export default function HistoryPage() {
    const [history, setHistory] = useState<DeletedItem[]>([]);
                                ...
                                <div className="flex-1">
                                    ...
                                    {item.type === 'book' ? (
                                        ...
                                        <div>
                                            ...
                                            {/* We could try to show book title if we had it stored in metadata, currently we only have bookId */}
                                        </div>
                                    )}
                                </div>
